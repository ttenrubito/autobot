        ...
        <div class="modal-body">
            <form id="createRepairForm">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="itemName" name="item_name" class="form-input" required
                                placeholder="เช่น นาฬิกา Rolex">
                        </div>
                    </div>
                    <div class="detail-grid">
                        <div class="form-group">
                            <label for="itemBrand">ยี่ห้อ</label>
                            <input type="text" id="itemBrand" name="item_brand" class="form-input"
                                placeholder="เช่น Rolex, Omega, Cartier">
                        </div>
                        <div class="form-group">
                            <label for="itemModel">รุ่น</label>
                            <input type="text" id="itemModel" name="item_model" class="form-input"
                                placeholder="เช่น Submariner, Speedmaster">
                        </div>
                    </div>
                    <div class="detail-grid">
                        <div class="form-group">
                            <label for="itemSerial">Serial Number</label>
                            <input type="text" id="itemSerial" name="item_serial" class="form-input"
                                placeholder="หมายเลขซีเรียล (ถ้ามี)">
                        </div>
                        <div class="form-group">
                            <label for="itemCondition">สภาพสินค้า</label>
                            <select id="itemCondition" name="item_condition" class="form-input">
                    ...
                    <div class="form-group">
                        <label for="itemDescription">รายละเอียดเพิ่มเติม</label>
                        <textarea id="itemDescription" name="item_description" class="form-input" rows="2"
                            placeholder="รายละเอียดสินค้า หมายเหตุเกี่ยวกับสภาพ"></textarea>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="repairIssue" name="issue" class="form-input" rows="2" required
                            placeholder="เช่น หน้าปัดแตก, เครื่องไม่เดิน"></textarea>
                    </div>
                    <div class="detail-grid">
                        <div class="form-group">
                            <label for="estimatedCost">ประเมินค่าซ่อม (บาท)</label>
                            <input type="number" id="estimatedCost" name="estimated_cost" class="form-input"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="repairNotes" name="notes" class="form-input" rows="2"
...
<script>
    ...
    async function submitCreateRepair() {
        ...
        try {
            const response = await fetch('/api/customer/repairs?action=create', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + getToken()
