...
class NotificationProcessor
{
    ...
    private function generatePawnInterestReminders()
    {
        ...
        $intervals = [
            ['days' => 7, 'type' => 'deposit_interest_7d', 'message' => "⏰ แจ้งเตือน: ดอกเบี้ยรับฝาก {{item_description}} ครบกำหนดในอีก 7 วัน ({{next_interest_due}})\nยอดดอกเบี้ย: {{interest_amount}} บาท 💰"],
            ['days' => 3, 'type' => 'deposit_interest_3d', 'message' => "⚠️ ดอกเบี้ยรับฝาก {{item_description}} ครบกำหนดในอีก 3 วัน!\nยอดดอกเบี้ย: {{interest_amount}} บาท\nกรุณาชำระเพื่อต่ออายุค่ะ 💳"],
            ['days' => 1, 'type' => 'deposit_interest_1d', 'message' => "🚨 ด่วน! ดอกเบี้ยรับฝาก {{item_description}} ครบกำหนดพรุ่งนี้!\nยอด: {{interest_amount}} บาท\nหากไม่ชำระจะมีค่าใช้จ่ายเพิ่มเติมค่ะ ⚠️"],
            ['days' => 0, 'type' => 'deposit_interest_due', 'message' => "🔴 ดอกเบี้ยรับฝาก {{item_description}} ครบกำหนดวันนี้!\nยอด: {{interest_amount}} บาท\nโปรดชำระโดยด่วนค่ะ 🙏"],
        ];
